...
public class InformationFrame extends JFrame implements ActionListener {
	...
	public InformationFrame(Calendar calendar, Utilities util, Event event) {
		this.calendar = calendar;
		this.util = util;
		this.event = event;
		this.setTitle("Modyfikuj wydarzenie");
	...
	private void createGUI() throws ParseException {
			...
			groupLayout.createParallelGroup(Alignment.TRAILING)
				.addGroup(groupLayout.createSequentialGroup()
					.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(groupLayout.createSequentialGroup()
							.addGap(231)
							.addComponent(change, GroupLayout.PREFERRED_SIZE, 82, GroupLayout.PREFERRED_SIZE)))
					.addContainerGap())
		);
		groupLayout.setVerticalGroup(
			groupLayout.createParallelGroup(Alignment.LEADING)
				...
				DATE_FORMAT_NOW = "HH:mm";
				date = event.getStartDate();
				sdf = new SimpleDateFormat(DATE_FORMAT_NOW);
				stringDate = sdf.format(date );
				startHourText.setText(stringDate);
				
				
				DATE_FORMAT_NOW = "dd-MM-yyyy";
				...
				sdf = new SimpleDateFormat(DATE_FORMAT_NOW);
				stringDate = sdf.format(date );
				endHourText.setText(stringDate);
				...
				descriptionText = new JTextArea(event.getDescription());
				
				JLabel label_2 = new JLabel("Miejsce:");
				
				locationText = new JTextField(event.getLocation());
