...
/** Konstruktor  klasy tworzącej sprecyzowany dokumentu*/
	...
	public Document2()
	{     needtable=true;
		  horizontal= new String[2]; size=5;
	      vertical= new String[5]; size2=1;
	      horizontal[0]=" Wina  ";
	      horizontal[1]=" Wina ";
...
/**Funkcja dodająca do generowanego dokumentu i do wskazanej tablicy  zawartość dokumentu
 * @param table wskazana tablica
 * @param inData dane jakie wymaga dokument, jakie firma musi podać */
